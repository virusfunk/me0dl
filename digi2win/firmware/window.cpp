...
void window(
    ...
    if (!loaded_weights) {
        ...
        nnet::load_weights_from_txt<model_default_t, 10440>(w2, "w2.txt");
        nnet::load_weights_from_txt<model_default_t, 58>(b2, "b2.txt");
        nnet::load_weights_from_txt<model_default_t, 10440>(w5, "w5.txt");
