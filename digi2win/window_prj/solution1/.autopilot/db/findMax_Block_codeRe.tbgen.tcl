set moduleName findMax_Block_codeRe
set isTopModule 0
...
set C_modelName {findMax_Block_codeRe}
set C_modelType { void 0 }
set C_modelArgList {
	{ scalar_digi int 18432 regular {fifo 0}  }
...
set C_modelArgMapList {[ 
	{ "Name" : "scalar_digi", "interface" : "fifo", "bitwidth" : 18432, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ scalar_digi_dout sc_in sc_lv 18432 signal 0 } 
	{ scalar_digi_empty_n sc_in sc_logic 1 signal 0 } 
	{ scalar_digi_read sc_out sc_logic 1 signal 0 } 
	...
	{ max_0 sc_out sc_lv 32 signal 2 } 
	{ max_0_ap_vld sc_out sc_logic 1 outvld 2 } 
	{ max_1 sc_out sc_lv 9 signal 3 } 
	{ max_1_ap_vld sc_out sc_logic 1 outvld 3 } 
	{ max_2 sc_out sc_lv 6 signal 4 } 
	{ max_2_ap_vld sc_out sc_logic 1 outvld 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "scalar_digi_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":18432, "type": "signal", "bundle":{"name": "scalar_digi", "role": "dout" }} , 
 	{ "name": "scalar_digi_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "scalar_digi", "role": "empty_n" }} , 
 	{ "name": "scalar_digi_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "scalar_digi", "role": "read" }} , 
...
set PerformanceInfo {[
	...
	, {"Name" : "Interval", "Min" : "79464", "Max" : "79464"}
]}
...
set Spec2ImplPortList { 
	scalar_digi { ap_fifo {  { scalar_digi_dout fifo_data 0 18432 }  { scalar_digi_empty_n fifo_status 0 1 }  { scalar_digi_read fifo_update 1 1 } } }
