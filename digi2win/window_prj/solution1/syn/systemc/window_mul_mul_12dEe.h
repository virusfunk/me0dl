...
// ==============================================================
#ifndef __window_mul_mul_12dEe__HH__
#define __window_mul_mul_12dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(window_mul_mul_12dEe) {
    ...
    SC_CTOR(window_mul_mul_12dEe):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
