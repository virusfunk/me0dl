...
// ==============================================================
#ifndef __window_fpext_32nscud__HH__
#define __window_fpext_32nscud__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(window_fpext_32nscud) {
    ...
    SC_CTOR(window_fpext_32nscud):  ACMP_fpext_U ("ACMP_fpext_U") {
