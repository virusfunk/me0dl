...
// ==============================================================
#ifndef __window_mul_mul_12bkb__HH__
#define __window_mul_mul_12bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(window_mul_mul_12bkb) {
    ...
    SC_CTOR(window_mul_mul_12bkb):  ACMP_smul_ss_U ("ACMP_smul_ss_U") {
